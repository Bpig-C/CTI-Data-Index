...
<!-- ![alt 属性文本](数据收集过程.png "CTI数据收集及数据集形成过程") -->
## Universal Framework for Constructing Threat Intelligence Analysis Datasets
<div>
    <!-- <img src="数据收集过程.png" alt="Kimi的图片"> -->
    <img src="模型框架图（未完成）.drawio.svg" >
    <figcaption style="text-align: center;">CTI数据收集及数据集形成过程</figcaption>
</div>
